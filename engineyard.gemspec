...
Gem::Specification.new do |s|
  ...
  s.add_dependency('engineyard-serverside-adapter', '=2.0.0.pre4')   # This line maintained by rake; edits may be stomped on
  s.add_dependency('engineyard-cloud-client', '~>1.0.3')
