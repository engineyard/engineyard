...
Gem::Specification.new do |s|
  ...
  s.add_dependency('engineyard-serverside-adapter', '=2.1.0')   # This line maintained by rake; edits may be stomped on
  s.add_dependency('engineyard-cloud-client', '~>1.0.14')
