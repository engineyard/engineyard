...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency('fakeweb-matcher', '= 1.2.3')
  ...
  #s.add_development_dependency('oj', '= 2.13.0')

  # Adding these to see if the tests will pass with a known good gemset
  # from https://travis-ci.org/engineyard/engineyard/jobs/89171906
  ...
  #s.add_development_dependency('diff-lcs', '= 1.2.5')
  s.add_development_dependency('mime-types', '= 2.6.2')
  #s.add_development_dependency('netrc', '= 0.11.0')
  #s.add_development_dependency('escape', '= 0.0.4')
  #s.add_development_dependency('highline', '= 1.6.21')
  s.add_development_dependency('unf_ext', '= 0.0.7.1')
  s.add_development_dependency('net-ssh', '= 2.9.2')
  #s.add_development_dependency('fakeweb', '= 1.3.0')
  #s.add_development_dependency('rspec-core', '= 2.99.2')
  #s.add_development_dependency('rspec-mocks', '= 2.99.4')
  ...
  s.add_development_dependency('data_objects', '= 0.10.16')
  s.add_development_dependency('oj', '= 2.13.0')
  #s.add_development_dependency('dm-core', '= 1.2.1')
  #s.add_development_dependency('launchy', '= 2.4.3')
  #s.add_development_dependency('gitable', '= 0.2.4')
  #s.add_development_dependency('rspec-expectations', '= 2.99.2')
  #s.add_development_dependency('engineyard-serverside-adapter', '= 2.4.0')
  #s.add_development_dependency('unf', '= 0.1.4')
  #s.add_development_dependency('rack-protection', '= 1.5.3')
  s.add_development_dependency('rdoc', '= 4.2.0')
  #s.add_development_dependency('realweb', '= 1.0.1')
  #s.add_development_dependency('simplecov', '= 0.10.0')
  #s.add_development_dependency('rabl', '= 0.11.6')
  #s.add_development_dependency('dm-aggregates', '= 1.2.0')
  #s.add_development_dependency('dm-do-adapter', '= 1.2.0')
  s.add_development_dependency('do_sqlite3', '= 0.10.16')
  #s.add_development_dependency('dm-migrations', '= 1.2.0')
  #s.add_development_dependency('dm-timestamps', '= 1.2.0')
  #s.add_development_dependency('ey_resolver', '= 0.2.2')
  #s.add_development_dependency('rspec', '= 2.99.0')
  s.add_development_dependency('domain_name', '= 0.5.25')
  s.add_development_dependency('sinatra', '= 1.4.6')
  #s.add_development_dependency('dm-sqlite-adapter', '= 1.2.0')
  #s.add_development_dependency('fakeweb-matcher', '= 1.2.3')
  s.add_development_dependency('http-cookie', '= 1.0.2')
  #s.add_development_dependency('rest-client', '= 1.8.0')
  #s.add_development_dependency('engineyard-cloud-client', '= 2.1.1')
