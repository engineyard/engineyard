...
Command:
  ...
  Restarts the application servers for the given application. Enables maintenance pages if they would be enabled during a normal deploy. Respects the maintenance_on_restart ey.yml configuration.
